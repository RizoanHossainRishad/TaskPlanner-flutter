...
import 'package:task_planner_demo/model_classes/listmodel.dart';
import 'package:task_planner_demo/screens/add_list.dart';
import 'package:task_planner_demo/screens/demoscreening.dart';
              ...
              children:snapshot.data!.map((contacts){
                return  Center(
                  child: ListTile(
                    ...
                    subtitle: Text("${contacts.tasks!.length}"),
                    trailing: Row(
